...
outdir_dir = r'/home/greydon/Downloads'
dseg_labels_file=r'/home/greydon/Documents/GitHub/seeg2bids-pipeline/resources/desc-subfields_atlas-bigbrain_dseg.tsv'
...
atlas_labels = pd.read_table(dseg_labels_file)
atlas_labels['lut']=atlas_labels[['r','g','b']].to_numpy().tolist()


for ihemi in ('L','R'):
	base_filename=f'{isub}_hemi-{ihemi}_space-T1w_desc-subfields_atlas-bigbrain_dseg'
	seg_file_fname = f'{data_dir}/hippunfold/hippunfold/{isub}/anat/{base_filename}.nii.gz'
	seg_out_fname = f'{outdir_dir}/hippunfold/hippunfold/{isub}/anat/{base_filename}.seg.nrrd'
