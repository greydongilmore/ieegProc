...
filedata, fileheader = nrrd.read(data_path + r'/derivatives/seega_scenes/'+f"sub-{isub}/sub-{isub}_desc-segmentations.seg.nrrd")
...
data_obj=nb.load(data_path + r'/derivatives/seega_scenes/'+f'sub-{isub}/sub-{isub}_desc-segmentations.nii.gz')
data = bbox2(data_obj.get_fdata())
nrrd.write(data_path + '/derivatives/seega_scenes/'+f'sub-{isub}/sub-{isub}_desc-segmentations.seg.nrrd', data, fileheader)
