...
isub="P073"
atlas_labels = pd.read_table(r'/home/stereotaxy/Documents/GitHub/seeg2bids-pipeline/resources/tpl-MNI152NLin2009cSym/tpl-MNI152NLin2009cSym_atlas-CerebrA_dseg.tsv')
nrrd.reader.ALLOW_DUPLICATE_FIELD = False
filedata, fileheader = nrrd.read(r'/media/stereotaxy/3E7CE0407CDFF11F/data/iEEG/imaging/clinical/derivatives/seega_scenes/sub-'+f"{isub}/sub-{isub}_desc-segmentations.seg.nrrd")
...
data_obj=nb.load(r'/media/stereotaxy/3E7CE0407CDFF11F/data/iEEG/imaging/clinical/derivatives/seega_scenes/'+f'sub-{isub}/sub-{isub}_desc-segmentations.nii.gz')
data = bbox2(data_obj.get_fdata())
nrrd.write('/media/stereotaxy/3E7CE0407CDFF11F/data/iEEG/imaging/clinical/derivatives/seega_scenes/'+f'sub-{isub}/sub-{isub}_desc-segmentations.seg.nrrd', data, fileheader)
