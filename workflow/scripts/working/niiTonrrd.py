...
filedata, fileheader = nrrd.read(r'/home/greydon/Documents/data/SEEG/derivatives/seega_scenes/'+f"sub-{isub}/sub-{isub}_desc-segmentations.seg.nrrd")
...
data_obj=nb.load(r'/home/greydon/Documents/data/SEEG/derivatives/seega_scenes/'+f'sub-{isub}/sub-{isub}_desc-segmentations.nii.gz')
data = bbox2(data_obj.get_fdata())
nrrd.write('/home/greydon/Documents/data/SEEG/derivatives/seega_scenes/'+f'sub-{isub}/sub-{isub}_desc-segmentations.seg.nrrd', data, fileheader)
